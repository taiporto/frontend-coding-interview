...
export default function SignInPage() {
  ...
  return (
    <div className="flex w-[319px] flex-col gap-[40px] md:my-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-[24px]">
        <FormControl
          ...
          label="Username"
          type="text"
          error={erroredField === FieldNames.USERNAME}
        />
        <FormControl
          aria-required="true"
          required
          ...
          label="Password"
          type="password"
          error={erroredField === FieldNames.PASSWORD}
        />
        {erroredField && (
          <p id="error-message" className="text-red-500">
            Please fill in {erroredField}
          </p>
        )}
